...
local Commands = {
	"Anchor", "Blind", "Blur", "Bring", "BuildTools", "Crash", "Fling", "Fly", "Jail", "Kill", "Morph", "Mute", "NoClip", "PlaySound", 
	"PromptPurchase", "SendTo", "SetJP", "SetSpeed", "Sit", "Teleport", "Watch"
}
		...
		return {
			...
			["Blind"] = {
				...
				["Trigger"] = function(Player: Player, State)
					...
					if not BlindFrame then
						BlindFrame = PlrGui:FindFirstChild("_AdmBlind"):FindFirstChild("Frame")
					end
					
					game:GetService("TweenService"):Create(BlindFrame, TweenInfo.new(.45), {BackgroundTransparency = (State == true and 0 or 1)}):Play()
				end
			},
			["Blur"] = {
				["Name"] = "Blur",
